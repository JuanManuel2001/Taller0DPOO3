...
public class CalculadoraEstadisticas
{
	...
	public String atletaPertenecePais(String nombre_atleta)
	{
		Atleta elAtleta = buscarAtleta(nombre_atleta);
		String paisPertenece="";
		if (elAtleta != null)
		{
			paisPertenece=elAtleta.darPais().darNombre();
		}
	...
	private Atleta buscarAtleta(String nombreAtleta)
	{
		...
		{
			//System.out.println(atletas.get(i).darNombre());
